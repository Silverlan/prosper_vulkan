...
VlkDescriptorSet::VlkDescriptorSet(VlkDescriptorSetGroup &dsg, Anvil::DescriptorSet &ds) : IDescriptorSet {dsg}, m_descSet {ds} { m_apiTypePtr = static_cast<VlkDescriptorSet *>(this); }
